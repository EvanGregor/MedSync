-- Comprehensive Fix for Duplicate Doctor Records
...
BEGIN
    ...
    RAISE NOTICE 'Sample of remaining doctors:';
    FOR rec IN 
        ...
        LIMIT 5
    LOOP
        RAISE NOTICE '  User ID: %, Name: %, Created: %', rec.user_id, rec.name, rec.created_at;
    END LOOP;
END $$;
