...
## Short, private user identifiers

Run `scripts/user-short-ids.sql` in Supabase to create `public.user_short_ids` and auto-assign a 10-char `short_id` for every user. You can reference patients by this short ID instead of UUIDs for privacy.
